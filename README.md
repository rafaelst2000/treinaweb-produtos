<h1 align=center>
Treinaweb - React: Tópicos Avançados
</h1>
...
Projeto desenvolvido durante as aulas de **Tópios Avançados**, utilizando as tecnologias ***ReactJS, Javascript e Node.js***.
...
#### **:computer: Frontend**
> 1. $cd treinaweb-produtos
> 2. $npm install
> 3. $npm start
> 4. $tw-dev-server (para iniciar um servidor que simula uma base de dados)
